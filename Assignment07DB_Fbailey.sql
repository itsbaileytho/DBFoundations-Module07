...
-- 2021-05-27,FBailey,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_FBailey')
	 Begin 
	  Alter Database [Assignment07DB_FBailey] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_FBailey;
	 End
	Create Database Assignment07DB_FBailey;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_FBailey;
...
Select prod.ProductName,
	[InventoryDate] = DateName(mm, inv.InventoryDate) + ', ' + DateName(yy, inv.InventoryDate),
	[InventoryCount] = inv.[Count]
From vProducts as Prod
	Inner Join Inventories as Inv on prod.ProductID = inv.ProductID
...
Group by cat.CategoryName, InventoryDate
...
Select Top 100000
	ProductName, InventoryDate, InventoryCount, [PreviousMonthCount], [CountVersusPreviousCountKPI] = isNull(Case
...
Returns Table as
Return Select
		ProductName, InventoryDate, InventoryCount, [PreviousMonthCount], [CountVersusPreviousCountKPI]
From vProductInventoriesWithPreviousMonthCountsWithKPIs
Where [CountVersusPreviousCountKPI] = @KPIValue;
go
